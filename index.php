...
<body class="bg-colonial-white-50">
    <nav id="navbar">
        <div class="container d-flex navbar-container justify-between items-center">
            ...
            <div class="nav-list h-fit d-flex justify-between">
                ...
                <a href="pages/news.php" class="font-montserrat d-inline-block text-colonial-white-950 nav-item">Berita</a>
                <a href="pages/product.php" class="font-montserrat d-inline-block text-colonial-white-950 nav-item">Produk</a>
            </div>
            <a href="pages/contact.php" class="font-montserrat nav-action text-white-50 bg-colonial-white-900 font-bold">Hubungi Kami</a>
        </div>
    </nav>
    <header class="hero-page">
        <div class="container h-full d-flex flex-col justify-center items-center">
            <div class="hero-page-text w-full h-fit">
                <p class="font-montserrat font-bold text-colonial-white-800 text-center">Selamat Datang di Sukasari Website</p>
                <p class="font-montserrat text-colonial-white-950 text-center">Publikasi Informasi Bermanfaat Untuk Warga Desa Sukasari</p>
            </div>
            <div class="hero-page-img w-full bg-colonial-white-300">
    ...
    <div class="visi-misi w-full bg-white-50">
        <div class="container h-full d-flex justify-center items-center">
            <div class="visi-misi-container d-grid">
                <div class="bg-colonial-white-400 visi d-flex flex-col justify-between">
                    <p class="font-bold font-montserrat text-white-50">Visi</p>
                    <p class="font-montserrat text-white-50">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam sed nemo, itaque exercitationem tempora repellat!</p>
                </div>
                <div class="bg-colonial-white-100 misi">
                    ...
                    <div>
                        <ol class="font-montserrat text-colonial-white-950">
                            <li>Memaksimalkan sistem Kerja Aaparatur Pemerintah Desa sesuai tugas, fungsi dan wewenang.</li>
                            <li>Menyelenggarakan Program Desa Berdasarkan Musyawarah Yang termuat dalam RPJM Desa, RKP Desa dan APB Desa.</li>
                ...
                <div class="bg-colonial-white-50 program-kerja">
        ...
        <div class="container h-full d-flex justify-center items-center">
            <div class="geology-container">
                ...
                <div class="maps-container w-full d-flex justify-between">
                    ...
                    <div class="citizen-information h-full bg-colonial-white-400 d-flex flex-col justify-center items-center">
                        <div>
                            <p class="font-bold font-montserrat text-white-50 text-center">234</p>
                            <p class="font-montserrat text-white-50 text-center">Keluarga</p>
                        </div>
                        <div>
                            <p class="font-bold font-montserrat text-white-50 text-center">58</p>
                            <p class="font-montserrat text-white-50 text-center">Pengusaha</p>
                        </div>
                        <div>
                            <p class="font-bold font-montserrat text-white-50 text-center">1478</p>
                            <p class="font-montserrat text-white-50 text-center">Penduduk</p>
                        </div>
                    </div>
                </div>
                <div class="location-description d-flex">
                    <div>
                        <p class="font-montserrat text-colonial-white-950">Kecamatan</p>
                        <p class="font-bold font-montserrat text-colonial-white-950">Serang Baru</p>
                    </div>
                    <div>
                        <p class="font-montserrat text-colonial-white-950">Kabupaten</p>
                        <p class="font-bold font-montserrat text-colonial-white-950">Bekasi</p>
                    </div>
                    <div>
                        <p class="font-montserrat text-colonial-white-950">Provinsi</p>
    ...
    <div class="news bg-colonial-white-200 w-full">
        <div class="container h-full d-flex justify-center items-center">
            <div class="news-container">
                <p class="font-montserrat font-bold text-colonial-white-950">Berita Masyarakat</p>
                <div class="news-content d-flex justify-between">
                    <div class="news-hot-topic h-full">
                        ...
                        <div class="news-hot-topic-text d-flex flex-col justify-between">
                            ...
                            <div class="hot-topic-information liquid-glass d-flex justify-between">
                                <div class="h-full">
                                    <p class="font-bold font-montserrat">Judul Berita</p>
                                    <p class="font-montserrat text-white-200">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Vero dolor iste culpa.</p>
                                </div>
                                <div class="h-full">
                    ...
                    <div class="news-recent h-full">
                        <div class="news-items-container w-full h-full d-flex flex-col justify-between">
                            <a href="" class="d-flex news-item bg-colonial-white-50 justify-between">
                                <div>
                                    <img src="assets/img/hero-page-image.jpg" alt="">
                                </div>
                                <div>
                                    <p class="font-bold font-montserrat text-colonial-white-950">Judul Berita</p>
                                    <p class="font-montserrat text-white-950">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aperiam, quas. Porro, ab?</p>
                                </div>
                            </a>
                            <a href="" class="d-flex news-item bg-colonial-white-50 justify-between">
                                <div>
                            ...
                            <a href="" class="d-flex justify-center items-center bg-colonial-white-50 font-bold font-montserrat text-colonial-white-950 news-cta">
                                Lebih Banyak Berita
                            </a>
                        </div>
                    </div>
    ...
    <div class="products bg-colonial-white-200 w-full">
        <div class="container h-full d-flex justify-center items-center">
            <div class="products-container">
                <p class="font-bold font-montserrat text-colonial-white-950">Produk Lokal</p>
                <div class="d-flex justify-between w-full h-fit">
                    <div class="product-card">
                        <img src="assets/img/hero-page-image.jpg" alt="">
                        <div class="product-card-detail ">
                            <div class="products-category w-full h-fit">
                                <div class="w-fit h-fit liquid-glass tag-item font-montserrat text-colonial-white-950">
                                    Makanan
                                </div>
                            </div>
                            <div class="product-detail d-flex flex-col justify-between bg-colonial-white-50">
                                <div class="product-detail-text">
                                    <p class="font-bold font-montserrat text-colonial-white-500">Nama Produk</p>
                                    <p class="font-montserrat text-colonial-white-950">
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem culpa unde alias.
                                    </p>
                                </div>
    ...
    <footer class="w-full">
        <div class="footer-content d-flex font-montserrat">
            <div class="footer-information h-full">
                ...
                <div class="footer-detail bg-colonial-white-100">
