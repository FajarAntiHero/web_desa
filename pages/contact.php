...
<head>
    ...
    <title>Kontak | Sukasari Website</title>
...
<body class="bg-colonial-white-50">
    ...
    <div class="hero-page-contact w-full d-flex items-center">
        <div class="container hero-page-contact-container bg-colonial-white-200 d-grid">
            <div class="hero-page-contact-img">
                <div class="w-full h-full">
                    <img src="../assets/img/hero-page-image.jpg" alt="" class="w-full h-full object-cover">
                </div>
            </div>
            <div class="hero-page-contact-form">
                <div class="w-full h-full bg-colonial-white-100">
                    <p class="font-bold font-montserrat text-colonial-white-950 scroll-element fade-top">Tanyakan Pada Kami</p>
                    <form action="" class="contact-form">
                        <div class="w-full h-full scroll-element scale-up">
                            <p class="font-bold font-montserrat text-colonial-white-950">Nama Lengkap</p>
                            <input type="text" id="name-contact" placeholder="Sumpi Gacoan" required class="font-montserrat text-colonial-white-950 w-full">
                        </div>
                        <div class="w-full h-full scroll-element scale-up">
                            <p class="font-bold font-montserrat text-colonial-white-950">Alamat Email</p>
                            <input type="text" id="email-contact" placeholder="sumpitgacoan@gmail.com" required class="font-montserrat text-colonial-white-950 w-full">
                        </div>
                        <div class="w-full h-full scroll-element scale-up">
                            <p class="font-bold font-montserrat text-colonial-white-950">Pertanyaan</p>
                            <textarea name="" id="question" placeholder="a a mau nanya dong" required class="font-montserrat text-colonial-white-950 w-full"></textarea>
                        </div>
                        <button class="font-bold font-montserrat text-white-50 w-full h-full bg-colonial-white-900 scroll-element scale-up">Kirim Pertanyaan</button>
                    </form>
                </div>
            </div>
            <div class="hero-page-contact-decoration bg-colonial-white-50 relative">
                <div></div>
            </div>
            <div class="hero-page-contact-decoration bg-colonial-white-50 relative">
                <div></div>
